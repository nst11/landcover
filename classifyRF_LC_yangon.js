var roi = ee.FeatureCollection("users/nyeinsoethwal/Myanmar/Yangon_Boundary") // Study Area
...
var senb = sen_2017.select(['B2','B3','B4','B8'])
        .rename(['B2_sen','B3_sen','B4_sen','B8_sen']);
var srtmb = srtm.select(['elevation']);


var l8b = l8_2017.select(['B2','B3','B4']);
var senb = sen_2017.select(['B2','B3','B4']);
var srtmb = srtm.select(['elevation']);

//Create Composite
var combined = l8b.addBands(senb).addBands(srtmb).addBands(ndvi_l8).addBands(ndvi_sen).addBands(ndbi_l8).addBands(ndbi_sen);

var bands = ['B2','B3','B4'];
var bandnames = ['B2_l8','B3_l8','B4_l8','B5_l8','B2_sen','B3_sen','B4_sen','B8_sen'];
